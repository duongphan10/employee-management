...
public class EmployeeRequestDto {
    ...
    public EmployeeRequestDto(EmployeeRequestFileDto dto) {
        this.fullName = dto.getFullName();
        this.code = dto.getCode();
        this.gender = dto.getGender();
        this.birthday = dto.getBirthday();
        this.hometown = dto.getHometown();
        this.ethnicity = dto.getEthnicity();
        this.religion = dto.getReligion();
        this.nationality = dto.getNationality();
        this.address = dto.getAddress();
        this.team = dto.getTeam();
        this.image = null;
        this.idCardNumber = dto.getIdCardNumber();
        this.idCardIssuedDate = dto.getIdCardIssuedDate();
        this.idCardIssuedLocation = dto.getIdCardIssuedLocation();
        this.phoneNumber = dto.getPhoneNumber();
        this.email = dto.getEmail();
        this.salary = dto.getSalary();
        this.salaryLevel = dto.getSalaryLevel();
        this.createdBy = null;
        this.departmentId = dto.getDepartmentId();
        this.positionId = dto.getPositionId();
        this.statusId = null;
    }
}
